...
(5, 'Happy Days', 2, '2007-10-02', 154, 7.9, 'https://csv2contact.groupspend.in/img/mms/HappyDays.jpg');
...
--
ALTER TABLE `mst_screenings`
  MODIFY `screening_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
